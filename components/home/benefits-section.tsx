    ...
    <section className="border-t border-warmNeutral-200 bg-white py-20 dark:border-warmNeutral-700 dark:bg-warmNeutral-900 md:py-24">
      <div className="container px-6 md:px-8 lg:px-4">
        <div className="mb-12 max-w-5xl md:mb-16">
          <p className="mb-4 font-mono text-[12px] font-bold uppercase tracking-[0.2em] text-gray-500 dark:text-warmNeutral-400">
            Outcomes
          </p>
        ...
        <div className="grid max-w-5xl gap-10 md:grid-cols-3 md:gap-8">
          {BENEFITS.map((b) => (
            <div
              key={b.title}
              className="border-t-4 border-stone-900 pt-6 dark:border-warmNeutral-100"
            >
              <p className="mb-5 inline-flex h-9 w-9 items-center justify-center rounded-md bg-stone-900 font-mono text-sm font-bold text-white dark:bg-warmNeutral-100 dark:text-warmNeutral-900">
                {b.index}
              </p>
              <h3 className="mb-3 text-2xl font-black tracking-tight">{b.title}</h3>
              <p className="mb-3 text-base leading-relaxed text-gray-600 dark:text-warmNeutral-300">
                {b.body}
              </p>
              <p className="mb-6 font-mono text-[12px] font-semibold uppercase tracking-[0.1em] text-gray-500 dark:text-warmNeutral-400">
                {b.who}
              </p>
              <Link
                href={b.href}
